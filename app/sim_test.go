...
import (
	...
	authsim "github.com/terra-project/core/x/auth/simulation"
	"github.com/terra-project/core/x/market"
	marketsim "github.com/terra-project/core/x/market/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *TerraApp) (
...
func testAndRunTxs(app *TerraApp) []simulation.WeightedOperation {
	cdc := MakeCodec()
	...
	return []simulation.WeightedOperation{
		...
		},
		{
			...
			oraclesim.SimulateMsgPrevote(app.oracleKeeper),
		},
		{
			func(_ *rand.Rand) int {
				var v int
			...
			oraclesim.SimulateMsgVote(app.oracleKeeper),
		},
		{
			func(_ *rand.Rand) int {
				var v int
...
func invariants(app *TerraApp) []sdk.Invariant {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/TerraApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
